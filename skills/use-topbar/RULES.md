...
- **Atlas** opens the EOS / Fusion sidebar. Default it **on** when the app has any AI, agent, or assistant intent. Do not add a custom in-app chat as a substitute; wire context and actions with `integrate-fusion-agent`.
