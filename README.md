...
| **use-selected-location-filters** | Reads the user's selected CDF location filters via `api.getSelectedLocationFilters()` from `@cognite/app-sdk` — for scoping queries and UI by Fusion location |
