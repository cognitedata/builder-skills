...
| **connect-atlas-mcp** | Fusion Start building — run the injected Industrial MCP command (`claude mcp add-json`, `cursor --add-mcp`, `code --add-mcp`) as written, finish browser OAuth, explore this project's data models |
