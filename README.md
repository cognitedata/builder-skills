...
| **flows-review-checks** | Shared technical-review bar (hunts, coverage scope, 13 criteria). Loaded by `flows-code-review` and by external review skills — do not copy |
