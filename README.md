...
| **start-custom-app** | Localhost-first Custom app start — Industrial MCP OAuth (browser, not `claude mcp add-json`), `token/inspect` / `appHostingAcl`, data-model curiosity, local HTTPS, App-Brief after the conversation |
